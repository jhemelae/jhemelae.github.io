...
{% for i in (2..199) %} <figure><img src="/images/reducibles-{{i}}.png" alt="Pattern for n={{i}}" width="144" style="vertical-align: middle;"><figcaption style="line-height:4px;">$$n={{i}}$$</figcaption></figure> {% endfor %}
</div>
